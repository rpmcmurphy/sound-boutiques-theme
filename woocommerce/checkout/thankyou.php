...
<div class="woocommerce-order thank-you-wrapper">
    ...
    ?>
        ...
        <?php if ($order->has_status('failed')) : ?>
            ...
            <div class="thank-you-failed">
                ...
                <p class=" woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions">
                    <a href="<?php echo esc_url($order->get_checkout_payment_url()); ?>" class="button pay custom-button"><?php esc_html_e('Pay', 'woocommerce'); ?></a>
                    <?php if (is_user_logged_in()) : ?>
                        <a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>" class="button pay custom-button"><?php esc_html_e('My account', 'woocommerce'); ?></a>
                    <?php endif; ?>
                </p>
            </div>
        ...
        <div class="thank-you-order-details-info">
