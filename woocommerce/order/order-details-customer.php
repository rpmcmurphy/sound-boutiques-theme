...
<section class="woocommerce-customer-details">
	...
	<div class="title-wrapper d-flex align-items-center justify-content-between">
		<h2 class="woocommerce-column__title entry-title"><?php esc_html_e( 'Billing address', 'woocommerce' ); ?></h2>
	</div>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address">
			<div class="title-wrapper d-flex align-items-center justify-content-between">
				<h2 class="woocommerce-column__title entry-title"><?php esc_html_e( 'Shipping address', 'woocommerce' ); ?></h2>
			</div>
			<address>
