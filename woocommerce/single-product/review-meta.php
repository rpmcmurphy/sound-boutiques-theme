...
<?php } else { ?>
	...
	<p class="meta">
		...
		?>
		<time class="woocommerce-review__published-date review-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></time>
	</p>
